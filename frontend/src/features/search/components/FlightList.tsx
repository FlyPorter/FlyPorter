        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start space-y-3 sm:space-y-0">
            <div className="flex-1 w-full">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mt-2 sm:mt-1">
                All times are shown in origin city time
              </div>
            </div>
            <div className="ml-0 sm:ml-4 text-left sm:text-right w-full sm:w-auto mt-2 sm:mt-0 border-t sm:border-t-0 pt-2 sm:pt-0">
              <div className="text-base sm:text-lg lg:text-xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">
                ${flight.price}
              </div>
            </div>
          </div>
